    ...
    <section className="relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 py-20 md:py-28 grid md:grid-cols-2 gap-12 items-center">
        <div className="animate-fade-in">
          ...
          <h1 className="mt-6 text-4xl sm:text-5xl md:text-6xl font-bold tracking-tight leading-[1.05] text-pretty text-[var(--color-publiora-black)]">
          ...
          <div className="mt-8 flex flex-wrap items-center gap-x-4 gap-y-2 text-sm text-[var(--color-medium-gray)]">
        ...
        <div className="relative max-w-full overflow-hidden">
          <div className="pointer-events-none absolute inset-4 sm:inset-0 bg-[var(--color-gold-soft)] rounded-[40px] blur-3xl opacity-40 md:rotate-3" />
          <div className="relative max-w-full rounded-[32px] border border-[var(--color-publiora-border)] bg-white shadow-[var(--shadow-pop)] p-5 md:rotate-1 md:hover:rotate-0 transition-transform duration-300">

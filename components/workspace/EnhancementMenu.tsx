...
const ENHANCEMENT_ACTIONS: EnhancementActionDef[] = [
  ...
  { label: "Persingkat", description: "Ringkas tulisan tanpa menghilangkan inti", action: "shorten" },
  ...
  { label: "Tambah contoh", description: "Tambahkan contoh konkret untuk memperjelas", action: "add_examples" },
  { label: "Tambah checklist", description: "Tambahkan checklist langkah atau poin penting", action: "add_checklist" },
];
  ...
  return (
    <div ref={ref} className="relative inline-block">
      <button
        ...
        aria-label="Sempurnakan bagian"
        title={disabled ? "Tidak ada konten bagian untuk disempurnakan" : "Sempurnakan bagian dengan AI"}
      >
        {loading ? (

...
import { buildPublishedReaderUrl } from "@/lib/urls";
    ...
    <div className="flex flex-col gap-4 sm:flex-row sm:flex-row sm:items-start">
      ...
      <div className="min-w-0 flex-1">
        ...
        <div className="mt-4 flex flex-wrap items-center gap-2">
          <Link href={buildPublishedReaderUrl(ebook.slug)} target="_blank" rel="noopener noreferrer" aria-label={publishedId.reader}>

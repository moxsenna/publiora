    ...
    <div ref={ref} className={cn("relative inline-block", className)}>
      ...
      {open && (
        <div
          ...
          role="menu"
          className={cn(
            "absolute top-full mt-1.5 min-w-[180px] rounded-xl border border-[var(--color-publiora-border)] bg-white shadow-[var(--shadow-pop)] py-1 z-50 animate-scale-in transition-transform",

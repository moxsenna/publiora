export const dashboardId = {
  ...
  retry: "Coba lagi",
  readerToCreatorTitle: "Punya pengetahuan yang ingin dibagikan?",
  readerToCreatorBody1: "Anda sudah menggunakan Publiora sebagai pembaca.",
  readerToCreatorBody2: "Sekarang Anda juga dapat membuat ebook dengan akun yang sama.",
  readerToCreatorCta: "Buat ebook pertama",
} as const;

...
export const workspaceId = {
  ...
  writeCurrentSection: "Tulis section ini",
  writeAllSections: "Tulis semua section",
  writeSection: "Tulis section",
  sectionNotWrittenTitle: (title: string) => `Section "${title}" belum ditulis`,
  sectionNotWrittenDesc: "Mulai tulis konten section ini menggunakan AI atau tulis seluruh section sekaligus secara otomatis.",

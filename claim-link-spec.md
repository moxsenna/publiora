...
MVP claim success behavior:
After a successful claim, Publiora should create entitlement, add the ebook to the reader library, then redirect directly to the reader page with a small "Added to your library" confirmation. Library remains the storage destination, but reader access should be immediate.


Revision note — MVP claim success behavior:
After a successful claim, Publiora should create entitlement, add the ebook to the reader library, then redirect directly to the reader page with a small "Added to your library" confirmation. Library remains the storage destination, but reader access should be immediate.
...
→ Redirect directly to reader→ Ebook added to library
...
Redirect:
Already in your library. Open reader directly.Redirect:
